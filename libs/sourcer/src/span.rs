...
impl Span {
    ...
    /// Marks this span as synthetic, indicating it was generated by the compiler rather than directly from source text.
    /// This can be used to distinguish between spans that correspond to actual source code and those that represent compiler-generated constructs.
    ///
    /// ### Args
    /// * `val`: Whether to mark the span as synthetic (true) or not (false).
    ///
    /// ### Returns
    /// A new Span with the updated synthetic status.
    ///
    /// Note: This method does not modify the original span, but returns a new span with the updated synthetic status.
    pub fn mark_synthetic(mut self, val: bool) -> Self {
        self.is_synthetic = val;
        self
    }
}
...
impl Span {
    ...
    /// Returns whether this span is marked as synthetic.
